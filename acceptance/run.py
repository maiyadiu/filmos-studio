    ...
    *(check for check in RC_LOCAL_CHECKS if check.check_id == "production-generation-composition"),
    Check(
        ...
        ("node_modules/.bin/tsx", "--test", "test/agent-tool-broker.test.ts", "test/agent-session-manager.test.ts",
         ...
         "../packages/filmos-agent-tool-contracts/test/generator-isolation.test.mjs",
    ...
    Check(
        ...
        ("bun", "test", "test/auth-session.test.ts", "test/project-shot-tools.test.ts", "test/project-shot-review.test.ts",
         "test/asset-image-preview.test.tsx", "test/generation-storage-consistency.test.ts",
         "test/image-node-settings.test.ts", "test/local-dreamina-generation.test.ts", "test/runtime-account-client.test.ts", "test/local-runtime.test.ts",
         ...
         "test/agent-session-observation.test.ts", "test/source-maintenance-action.test.ts", "test/canvas-agent-workflow.test.ts", "test/ai-message-markdown.test.tsx",
