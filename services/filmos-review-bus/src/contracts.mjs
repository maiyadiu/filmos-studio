import { REVIEW_MAIN_STATES } from "./generated-review-contract.mjs";
...
export const MAIN_STATES = REVIEW_MAIN_STATES;

export { ARCHITECTURE_V2_STATES as ARCHITECTURE_STATES } from "./architecture-protocol.mjs";
