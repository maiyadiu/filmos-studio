...
type SessionPatch = Partial<Pick<BrainSession, "providerThreadId" | "permissionGrantId" | "status" | "lastContextReceiptId" | "latestPlan" | "latestModelReceipt" | "latestTurnReceipt" | "sourceMaintenance" | "hostHandoff" | "hostHandoffTimeline" | "updatedAt" | "closedAt">>;
